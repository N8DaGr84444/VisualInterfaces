class V2Line {
    ...
    initVis() {
        ...
        // create stack:
        // const stack = d3.stack().keys([vis.data, d => d.cat]);
        console.log('vis data: ', vis.data)
        const stack = d3.stack().keys(['co', 'no2', 'ozone', 'so2', 'pm25', 'pm10'])
        // const stackedData = stack(vis.data)
        vis.groupedData = d3.groups(vis.data, (d) => d.year);
        const stackedData = stack(vis.groupedData)
